...
(
    course_uuid                    VARCHAR(64) NOT NULL PRIMARY KEY,
    school_uuid                    VARCHAR(64) NOT NULL,
    course_code                    VARCHAR(32) NOT NULL,
    course_name                    VARCHAR(64) NOT NULL,
    course_english_name            VARCHAR(128),
    department_uuid                VARCHAR(64) NOT NULL,
    course_category_uuid           VARCHAR(64),
    course_property_uuid           VARCHAR(64),
    course_type_uuid               VARCHAR(64) NOT NULL,
    course_nature_uuid             VARCHAR(64),
    total_hours                    DECIMAL(10, 2) DEFAULT 0,
    week_hours                     DECIMAL(10, 2) DEFAULT 0,
    theory_hours                   DECIMAL(10, 2) DEFAULT 0,
    experiment_hours               DECIMAL(10, 2) DEFAULT 0,
    practice_hours                 DECIMAL(10, 2) DEFAULT 0,
    computer_hours                 DECIMAL(10, 2) DEFAULT 0,
    credit                         DECIMAL(10, 2) DEFAULT 0,
    theory_classroom_type_uuid     VARCHAR(64),
    experiment_classroom_type_uuid VARCHAR(64),
    practice_classroom_type_uuid   VARCHAR(64),
